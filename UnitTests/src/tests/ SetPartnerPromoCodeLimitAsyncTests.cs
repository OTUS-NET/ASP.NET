...
{
    public class SetPartnerPromoCodeLimitAsyncTeststs
    {
        [Theory, AutoMoqData]
        public async Task SetPartnerLimitAsync_PartnerIsNotFound_ReturnsNotFound(Guid partnerId, Guid limitId, [Frozen] Mock<IPartnerRepository> partnerRepositoryMock, PartnersController partnersController)
        {
            //Arrange
        ...
        [Theory, AutoMoqData]
        public async Task SetPartnerLimitAsync_PartnerIsNotActive_ReturnsBadRequest(
            Partner partner,
            Guid limitId,
