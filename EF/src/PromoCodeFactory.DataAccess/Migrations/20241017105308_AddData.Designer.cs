...
namespace PromoCodeFactory.DataAccess.Migrations
{
    ...
    [Migration("20241017105308_AddData")]
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.Administration.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 10, 17, 10, 53, 8, 503, DateTimeKind.Utc).AddTicks(1340))
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 10, 17, 10, 53, 8, 503, DateTimeKind.Utc).AddTicks(1600))
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.Administration.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 10, 17, 10, 53, 8, 506, DateTimeKind.Utc).AddTicks(3680))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 10, 17, 10, 53, 8, 506, DateTimeKind.Utc).AddTicks(3860))
                        .HasColumnName("updated_at");
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 10, 17, 10, 53, 8, 498, DateTimeKind.Utc).AddTicks(8720))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 10, 17, 10, 53, 8, 499, DateTimeKind.Utc).AddTicks(9640))
                        .HasColumnName("updated_at");
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.Preference", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 10, 17, 10, 53, 8, 505, DateTimeKind.Utc).AddTicks(1410))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 10, 17, 10, 53, 8, 505, DateTimeKind.Utc).AddTicks(1670))
                        .HasColumnName("updated_at");
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.PromoCode", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 10, 17, 10, 53, 8, 505, DateTimeKind.Utc).AddTicks(8270))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 10, 17, 10, 53, 8, 505, DateTimeKind.Utc).AddTicks(8560))
                        .HasColumnName("updated_at");
