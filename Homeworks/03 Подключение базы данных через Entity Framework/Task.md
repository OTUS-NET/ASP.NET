...
4. Реализация контроллера PromoCodesController
    - Реализовать методы Get, GetById, Create (Создать промокод и выдать его клиентам с указанным предпочтением), Apply (отметить использование промокода клиентом)
5. Миграции
