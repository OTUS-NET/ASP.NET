    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cusomers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerPreference_Cusomers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Cusomers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerPromoCodes_Cusomers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Cusomers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
