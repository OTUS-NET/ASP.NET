...
namespace PromoCodeFactory.DataAccess.Migrations
{
    ...
    [Migration("20250202180739_InitialCreate")]
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8b6fedd0-36ba-4887-b1b9-ab5e06a8ef4c"),
                            BeginDate = new DateTime(2025, 2, 2, 18, 7, 37, 294, DateTimeKind.Utc).AddTicks(8727),
                            Code = "THEATRE",
                            CustomerId = new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"),
                            EndDate = new DateTime(2025, 3, 4, 18, 7, 37, 294, DateTimeKind.Utc).AddTicks(8834),
                        ...
                        new
                        {
                            Id = new Guid("1b390a47-59de-4ade-ae34-b9627ba9e5cc"),
                            BeginDate = new DateTime(2025, 2, 2, 18, 7, 37, 294, DateTimeKind.Utc).AddTicks(9221),
                            Code = "FAMILY",
                            CustomerId = new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"),
                            EndDate = new DateTime(2025, 4, 3, 18, 7, 37, 294, DateTimeKind.Utc).AddTicks(9221),
                            PartnerManagerId = new Guid("451533d5-d8d5-4a11-9c7b-eb9f14e1a32f"),
                            PreferenceId = new Guid("c4bda62e-fc74-4256-a956-4760b3858cbd"),
