...
public static class DependencyInjection
{
    public static void AddEfDataAccess(this IServiceCollection services)
    {
        services.AddDbContext<PromoCodeFactoryDbContext>((sp, builder) =>
        {
            ...
            // исправил имя
            var connectionString = sp.GetRequiredService<IConfiguration>().GetConnectionString("PromocodeFactoryDb")
                                   ?? throw new InvalidOperationException("Connection string 'PromocodeFactoryDb' not found.");
