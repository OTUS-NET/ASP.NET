...
namespace Pcf.ReceivingFromPartner.WebHost.Controllers
{
        ...
        : ControllerBase
    {
            ...
            ReceivingPromoCodeRequest request)
        {
            ...
            var message = new PromoCodeIntegrationEvent
            {
                ServiceInfo = promoCode.ServiceInfo,
                PartnerId = promoCode.PartnerId,
                PromoCode = promoCode.Code,
                PreferenceId = promoCode.PreferenceId,
                PartnerManagerId = promoCode.PartnerManagerId ?? Guid.Empty,
                BeginDate = promoCode.BeginDate.ToString("yyyy-MM-dd"),
                EndDate = promoCode.EndDate.ToString("yyyy-MM-dd")
            };
            ...
            {
                await _publishEndpoint.Publish(new PartnerManagerIntegrationEvent { PartnerId = request.PartnerManagerId.Value });
            }
