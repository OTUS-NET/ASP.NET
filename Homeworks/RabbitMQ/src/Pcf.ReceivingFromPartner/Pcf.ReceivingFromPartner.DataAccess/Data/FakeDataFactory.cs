            ...
            new Partner()
            {
                ...
                [
                    new PartnerPromoCodeLimit()
                    {
                        ...
                        CreateDate = new DateTime(2020, 5, 3).ToUniversalTime(),
                        EndDate = new DateTime(2020, 10, 15).ToUniversalTime(),
                        CancelDate = new DateTime(2020, 6, 16).ToUniversalTime(),
                        Limit = 1000
                    },
                    new PartnerPromoCodeLimit()
                    {
            ...
            new Partner()
            {
                ...
                [
                    new PartnerPromoCodeLimit()
                    {
                        ...
                        CreateDate = new DateTime(2020, 7, 3).ToUniversalTime(),
            ...
            new Partner()
            {
                ...
                [
                    new PartnerPromoCodeLimit()
                    {
                        ...
                        CreateDate = new DateTime(2020, 9, 6).ToUniversalTime(),
                        EndDate = DateTime.UtcNow.AddMonths(1),
                        Limit = 15
                    }
                ]
